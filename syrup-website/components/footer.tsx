        ...
        <footer className="relative overflow-hidden bg-gradient-to-t from-amber-50 to-white text-gray-900">
            ...
            <div className="container relative mx-auto px-4 py-16">
                ...
                <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-700">
                            The open-source browser extension that helps you save money with real promo codes.
                        </p>
                        <div className="flex gap-4">
                            ...
                            <Button variant="ghost" size="icon" asChild>
                                <Link href="https://twitter.com/getsyrup">
                            ...
                            <Button variant="ghost" size="icon" asChild>
                                ...
                                <svg className="h-5 w-5" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Discord</title><path d="M20.317 4.3698a19.7913 19.7913 0 00-4.8851-1.5152.0741.0741 0 00-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 00-.0785-.037 19.7363 19.7363 0 00-4.8852 1.515.0699.0699 0 00-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 00.0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 00.0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 00-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 01-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 01.0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 01.0785.0095c.1202.099.246.1981.3728.2924a.077.077 0 01-.0066.1276 12.2986 12.2986 0 01-1.873.8914.0766.0766 0 00-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 00.0842.0286c1.961-.6067 3.9495-1.5219 6.0023-3.0294a.077.077 0 00.0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.061 0 00-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.946 2.4189-2.1568 2.4189Z"/></svg>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Button variant="link" className="h-auto p-0 text-gray-700 hover:text-black" asChild>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Button variant="link" className="h-auto p-0 text-gray-700 hover:text-black" asChild>
                                    <Link href="https://github.com/Abdallah-Alwarawreh/Syrup">Documentation</Link>
                                </Button>
                            </li>
                            <li>
                                <Button variant="link" className="h-auto p-0 text-gray-700 hover:text-black" asChild>
                                    <Link href="https://dsc.gg/Hexium">Contact Us</Link>
                                </Button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Button variant="link" className="h-auto p-0 text-gray-700 hover:text-black gap-2" asChild>
                                    <Link href="https://chromewebstore.google.com/detail/syrup/odfgjmajnbkiabjnfiijllkihjpilfch">
                                        <svg className="h-4 w-4" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Google Chrome</title><path d="M12 0C8.21 0 4.831 1.757 2.632 4.501l3.953 6.848A5.454 5.454 0 0 1 12 6.545h10.691A12 12 0 0 0 12 0zM1.931 5.47A11.943 11.943 0 0 0 0 12c0 6.012 4.42 10.991 10.189 11.864l3.953-6.847a5.45 5.45 0 0 1-6.865-2.29zm13.342 2.166a5.446 5.446 0 0 1 1.45 7.09l.002.001h-.002l-5.344 9.257c.206.01.413.016.621.016 6.627 0 12-5.373 12-12 0-1.54-.29-3.011-.818-4.364zM12 16.364a4.364 4.364 0 1 1 0-8.728 4.364 4.364 0 0 1 0 8.728Z"/></svg>
                                        Chrome Extension
                                    </Link>
                                </Button>
                            </li>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-700">
                    <p>© 2024 - {new Date().getFullYear()} Syrup. All rights reserved.</p>
